...
这个阵的命题，是在天台环境下，通过 23 炮+曾的形状早激活，达成无拦截效果（一开始是想做一个 C4u 无拦截裸轨的阵，但是这个构型要求必须 PS 激活，实在复用不开）。

由于 23 炮的存在，必须在巨人到达 626 之前使其投掷，否则可能直接越过南瓜啃炮（虽说有铲种换炮问题不大）。因此，两个冰波波长之和不能超过 2852，传统的（指压碑五炮式的）C7u 复用直接不成立了，所以这里要加入铲种。而且 2 列炮极其难用，完全收不到撑杆，很难全收小丑橄榄。但是小丑是必须要收的（不过第二冰波5路小丑没有全收，所以PA波A必须放在2路；唯一一次放在4路那波是全收小丑的；但是即使不全收小丑也必须要全伤巨人），所以炸点很靠右，巨人会逃离爆炸范围。这时候排曾就有用了：会逃逸的巨人都是在冰波逃逸的，减速状态下巨人轻松收掉。

但是这里还是有问题。一是巨人：存在那种快，但不完全快的巨人，快到能逃离炮范围，但又慢到减速时间结束了还没进排曾攻击范围，于是原速冲过去一顿砸，所以5路垫一下，让这些巨人能尽量在第二冰波就被收掉（经过测试，5路还是有砸率，不过我确实优化不动了）；二是跳跳：w17 的核放在了4-8，这个位置无法全收1路跳跳，可能会偷家。不过这种跳跳刚跳过曾就会被减速，问题应该不大；三是收尾，收尾的逻辑毫无智能判断，可能会提前结束收尾导致冷却转不过来；四是南瓜，南瓜压力感觉挺大的，多跑几次选卡可能会被啃爆。
