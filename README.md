...
- [whatss7-avz-scripts](#whatss7-avz-scripts)
  ...
  - [计划完成的阵型](#计划完成的阵型)
    ...
    - [RE 椭盘十四炮 ch4 未完成 不稳定](#re-椭盘十四炮-ch4-未完成-不稳定)
...
[P5: PP | PP | PP | PP | N (7, 7, 7, 7, 7)](./ME田八炮/tian8p-p5.cpp)

P5运阵过程好像比C8u稳定许多，但是收尾不知道该怎么收...
...
### RE 椭盘十四炮 ch4 未完成 不稳定

[ch4: I3PPDD-B-PP | I3PPDD-B-PP (18, 18)](./RE椭盘十四炮/ellipse14p.cpp)

通过seml测定，每1538.5波翻车1次；通过手动AvZ跳帧测定，6500波共翻车2次，一次炸掉3-8炮，一次炸掉4-8炮。概率上还行吧...
