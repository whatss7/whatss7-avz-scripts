...
- [whatss7-avz-scripts](#whatss7-avz-scripts)
  ...
  - [已完成的阵型](#已完成的阵型)
    ...
    - [RE 天台十炮 P5](#re-天台十炮-p5)
    - [DE 双冰六炮 ch5](#de-双冰六炮-ch5)
    - [PE 单紫卡十二炮 S6 不稳定](#pe-单紫卡十二炮-s6-不稳定)
  - [计划完成的阵型](#计划完成的阵型)
...
[P5u-N: ccccPP | ccccPP | ccccPP | ccccPP | N  (7.5, 7.5, 7.5, 7.5, 6)](PE经典八炮/jd8p-P5u.cpp)
...
可以挂机，但是因为阵型本身问题（应该是本身问题吧）没减速到的小鬼会啃底线炮，所以其实还是不能挂机。
...
[S6: I-PP | PP | PP | PPDD | PP (12, 6, 6, 6, 6)](./PE单紫卡十二炮/dzk12p.cpp)

小鬼冲家啦！w10刷新延迟啦！QAQ
拦截似乎应该在第一个加速波就拦，但是这样能不能守六列还有待确认。小鬼就得多考虑一下了。不过虽然问题一堆，但是表演打个2f还是能打的。
w10刷新延迟好像真的没什么办法，看能不能再加运算量，或者这里从PPDD入轨也可以考虑。
所以完成了5个一级阵，勉强完成1个二级阵，似乎能认定键控一级了（
