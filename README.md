...
w10炸蹦极的炮要复用到w16 ice2后的第一个PSD处，所以这里调整了PSD时机，PS没能瞬杀的红眼也能被拦下来。上半场分一炮炸1路也是为了能拦下来，如果过早激活则D收不全撑杆。

w19需要垫材，这次我写的那个最佳垫材时机给出的结果对应时机垫不到，没办法了用速度计算器拉了个折线图看看次优解是怎样的。说不定以后也会把这个做到工具里面...
