...
- [whatss7-avz-scripts](#whatss7-avz-scripts)
  ...
  - [已完成的阵型](#已完成的阵型)
    ...
    - [RE L六炮 C6x 原创 不稳定](#re-l六炮-c6x-原创-不稳定)
  - [计划完成的阵型](#计划完成的阵型)
...
[(C6x? I6i? ch4?): I-PPDD" | I-PP | I3n-PPAd' (1782, 1782, 1782)](./REL六炮/l6p.cpp)
...
另外，这里也需要处理极其难用的 23 炮。这次不仅会漏撑杆，还会漏扶梯跳跳。PPDD 波与 PPDA 波只有撑杆问题，扶梯跳跳有拦截炮帮忙收，5-5 炮后面跟了个曾用来收撑杆；PPI3n 波则改炸 25 路，3 路的扶梯跳跳由核收。但这某种程度上影响了收尾，w18 若是炸 24，则中路火力叠加，w19 不再有靠前的红眼，激活炮可以拦截中路小鬼；然而没有，所以 JPSA 都是炸 5 路，防止激活 3 路引发投掷。
